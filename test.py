# -*- coding: utf-8 -*-
"""
Created on Mon Jan 11 12:32:13 2021
...
class Wave_Packet:
    def __init__(self, n_points, dt, sigma0=5.0, k0=1.0, x0=-150.0, x_begin=-200.0,
                 x_end=200.0, barrier_height=0.05, barrier_width=3.0):
...
wave_packet = Wave_Packet(n_points=500, dt=0.5, barrier_width=10, barrier_height=5, x0 =-150.0)
