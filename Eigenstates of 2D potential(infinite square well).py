...
w, v = eigsh(H, k=15, which='SM') #SM == smallest eigenvalues in magnitude
...
# plot(fig, auto_open=True, filename=r'plotly/eigenfunction, n=5.html')



####### energy levels ############
"""
Energy levels for an infinite square well are given by E = alpha(n_x^2 + n_y^2)

alpha = half the lowest eigenvalue

"""
alpha = w[0]/2
E_div_alpha = w/alpha

_ = np.arange(0,len(w),1)
plt.figure()
